...
namespace VolumetricFogAndMist {
    ...
    public partial class VolumetricFog : MonoBehaviour {
        ...
        const string VFM_BUILD_HINT = "VFMBuildHint121b1";
        ...
        [SerializeField, Range(0, 1f)]
        float
            _baselineRelativeToCameraDelay;
        ...
        [SerializeField, Range(0, 5f)]
        float
            _lightScatteringBrightnessThreshold;

        public float lightScatteringBrightnessThreshold {
            get { return _lightScatteringBrightnessThreshold; }
            set {
                if (value != _lightScatteringBrightnessThreshold) {
                    _lightScatteringBrightnessThreshold = value;
                    UpdateMaterialProperties();
                    isDirty = true;
                }
            }
        ...
        void OnEnable () {
            ...
            if (fogInstances.Count == 0) isInitialized = false;

            if (isInitialized) {
                ToggleCommandBuffers(true);
                return;
            }
            ...
            // need to know if this is a fog area or a fog renderer by checking if this gameobject has a camera component
        ...
        void OnDisable () {
            ToggleCommandBuffers(false);
        }

        void ToggleCommandBuffers (bool enabled) {
            if (enabled) {
                UpdateVolumeMask();
                SetupDirectionalLightCommandBuffer();
                ToggleSurfaceCapture(true);
            } else {
        ...
        void FindMainCamera () {
            ...
            if (mainCamera == null) {
                ...
                for (int k = 0; k < cams.Length; k++) {
                    if (cams[k].isActiveAndEnabled && cams[k].targetTexture == null) {
                        mainCamera = cams[k];
                        return;
                    }
                }
        ...
        bool IsPartOfScene () {
            VolumetricFog[] fogs = Misc.FindObjectsOfType<VolumetricFog>();
        ...
        void InitFogMaterial () {
            ...
            Shader fogShader = VolFogAssets.FindShader("VolumetricFogAndMist/VolumetricFog");
            if (fogShader != null) {
                fogMat = new Material(fogShader);
                fogMat.hideFlags = HideFlags.DontSave;
                fogMat.name = "FogMat " + name;
            }
            Texture2D noiseTexture = VolFogAssets.LoadTexture("Noise3");
            ...
            chaosLerpMat = new Material(VolFogAssets.FindShader("VolumetricFogAndMist/Chaos Lerp"));
        ...
        void RegisterWithRenderers () {
            ...
            allFogRenderers = Misc.FindObjectsOfType<VolumetricFog>();
...
#pragma warning restore 0162
        ...
        void GetTransparentDepth () {
            ...
            if ((object)depthShader == null) {
                depthShader = VolFogAssets.FindShader("VolumetricFogAndMist/CopyDepth");
            }
            if ((object)depthShaderAndTrans == null) {
                depthShaderAndTrans = VolFogAssets.FindShader("VolumetricFogAndMist/CopyDepthAndTrans");
            }
...
#pragma warning restore 0429
        ...
        void GetSunShadows () {
            ...
            if (depthSunCam == null) {
                ...
                if (depthSunShader == null) {
                    depthSunShader = VolFogAssets.FindShader("VolumetricFogAndMist/CopySunDepth");
                }
        ...
        void SetBlurTexture (RenderTexture source, RenderTextureDescriptor desc) {
            if (blurMat == null) {
                Shader blurShader = VolFogAssets.FindShader("VolumetricFogAndMist/Blur");
        ...
        public void CheckWaterLevel (bool baseZero) {
            ...
            if (water == null) {
                GameObject[] gos = Misc.FindObjectsOfType<GameObject>();
        ...
        void UpdateMaterialPropertiesNow (Camera mainCamera) {
            ...
            if (_jitterStrength > 0) {
                if (blueNoiseTex == null) blueNoiseTex = VolFogAssets.LoadTexture("BlueNoiseVF128");
...
#pragma warning restore 0162
        ...
        void UpdateScatteringData (Camera mainCamera) {
            ...
            if (viewportPos.z < 0) {
                ...
                fogMat.SetFloat(ShaderParams.FogScatteringBrightnessThreshold, _lightScatteringBrightnessThreshold);
        ...
        // Look for new lights
        void TrackNewLights () {
            lastFoundLights = Misc.FindObjectsOfType<Light>();
        }
        ...
        public void UpdateVolumeMask () {
            ...
            if (_enableMask) {
                ...
                if (maskMaterial == null) {
                    maskMaterial = new Material(VolFogAssets.FindShader("VolumetricFogAndMist/MaskWrite"));
                }

                // EFT embed: no VR, XR module not referenced — always the flat path
